(function (window) {
    ...
    function c3_axis(d3, params) {
        var scale = d3.scale.linear(), orient = "bottom", innerTickSize = 0, outerTickSize, tickPadding = 3, tickValues = null, tickFormat, tickArguments;
        ...
        function axis(g) {
            g.each(function () {
                ...
                function trimTickText(d, maxWidth){
                ...
                tspan = text.selectAll('tspan')
                    .data(function (d, i) {
                        var splitted = params.tickMultiline ? splitTickText(d, params.tickWidth) : trimTickText(d, params.tickWidth);
